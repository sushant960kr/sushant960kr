...
## 🔭 Current Projects  
- 🚆 **CI/CD Pipeline for Train-Schedule App** – Jenkins, Docker, Kubernetes on AWS  
- 🌦️ **Weather App** – Real-time forecasts using OpenWeatherMap API  
- ☁️ **Terraform AWS Automation** – Automated EKS provisioning  
- 🧪 **Cloud/DevOps Mini Projects** – Jenkins pipelines, Docker builds  
- 🟢 **MERN Practice Apps** – Full-stack learning projects  

---

## 🌱 Learning Focus  
- ☁️ **AWS** – VPC, EC2, IAM, S3, Lambda, EKS  
- 🔧 **DevOps** – Jenkins, Docker, Kubernetes  
- 🛠 **Terraform** – Cloud IaC automation  
- ⚛️ **React** – Components, hooks, UI development  

---

## 🛠 Need Help With  
- Advanced AWS deployments  
- Kubernetes scaling & clusters  
...
## 📫 Reach Me  
- 📧 Email: **sushant960kr@gmail.com**  
- 🐙 GitHub: **[sushant960kr](https://github.com/sushant960kr)**  
- 🔗 LinkedIn: **[linkedin.com/in/kr-sushant](https://linkedin.com/in/kr-sushant)**  

---

## ⚡ Fun Fact  
My code may fail, but my **DevOps pipelines never stop learning!** 😄  
...
<p align="left">
  ...
  <img src="https://skillicons.dev/icons?i=ansible" width="45"/>
  <img src="https://skillicons.dev/icons?i=terraform" width="45"/>
</p>
